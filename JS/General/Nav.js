...
function Mostrar_Navbar() {
  ...
  Contenedo_IdNav.innerHTML = `
    <a href="/Inicio.html"><img src="/Assets/Call-of-Duty-Emblem.jpg" class="logo mt4" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            ...
            <form class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-2 border-dark" type="text" placeholder="Search">
